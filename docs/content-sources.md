...
| Current status: "Grabando su próximo lanzamiento" (recording her next release) | Direct verbal feedback from Danni, relayed via WhatsApp voice message transcript during this project | N/A — artist's own words, not a public post | 2026-09-20 | Artist-provided current-activity statement, not a public announcement. Deliberately generic — no release name, date, or campaign details exist yet and none should be added until Danni/her team confirm them. Supersedes the earlier hero copy, which named CEFEIDA specifically (inaccurate: CEFEIDA was already released, not in progress). |
...
| Performance in Madrid, España, 2023 | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Still incomplete** — venue name not given, year only (no month/day). Displayed on-site as "Madrid, España — 2023". |
| Performance in Bogotá, Colombia, 2022 | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Still incomplete** — venue name not given, year only. Displayed on-site as "Bogotá, Colombia — 2022". |
| Two sold-out performances at "Foro del Tejedor," 2023 and 2024 | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Still incomplete** — city not given for either. Listed as two separate entries (one per year) since they're two distinct performances. Displayed as "Foro del Tejedor — 2023 — Sold out" and "— 2024 — Sold out". Note: an Instagram Highlight cover possibly reading "Foro del tej[edor]" was seen during earlier research, which may corroborate the venue name, but that alone isn't enough to confirm a city — not inferred here. |

## Bio (long-form, artist-provided)

| Fact | Source | Verified | Notes |
|---|---|---|---|
| Full paragraph bio: "licenciada en Producción Musical," pop identity (fresca/cercana, bailable, disco, 80s/2000s refs), composes+produces+vocal-produces her own material and other independent artists' from her home studio, has made music for brand jingles / political and commercial campaigns, a song aired on Televisa one Christmas season, "+1,000,000 reproducciones" on one song, "+12 mil oyentes mensuales" on Spotify, current era includes Yorokobi/Pecar, upcoming 2027 music | Direct message from the artist's team (pasted verbatim in this session) | 2026-09-20 | Primary source, highest priority. Used to substantially rewrite `components/ArtistBio.tsx`. The Televisa/Christmas song has no title or exact year given — kept generic ("una canción original suya," "la temporada navideña") rather than inventing specifics. The 2027-music mention is forward-looking with no title/date, so it was **not** added to the site (would read as an announced release). The two stats (streams, monthly listeners) are now displayed in the About section's metadata grid — these are point-in-time figures the artist gave us on 2026-09-20, not live-fetched data, and will go stale; whoever maintains this site should refresh `artist.stats` in `lib/data.ts` periodically rather than treat them as permanent. |
