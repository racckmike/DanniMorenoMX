...
| Performance in Madrid, España | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Incomplete** — no venue name or date given yet. Displayed on-site as "Madrid, España" only, with no secondary date/event line. Update `lib/data.ts` `pastShows` once venue + date are confirmed. |
| Performance in Bogotá, Colombia | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Incomplete** — no venue name or date given yet. Same treatment as Madrid above. |
| Performance at "Foro del Tejedor" | Direct message from the artist's team | N/A — artist's own words | 2026-09-20 | **Incomplete** — no city or date given yet. Displayed on-site as "Foro del Tejedor" only. Note: an Instagram Highlight cover possibly reading "Foro del tej[edor]" was seen during earlier research, which may corroborate this, but that alone isn't enough to confirm a city — not inferred here. |
